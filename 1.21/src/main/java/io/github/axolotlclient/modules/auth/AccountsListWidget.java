...
public class AccountsListWidget extends AlwaysSelectedEntryListWidget<AccountsListWidget.Entry> {
	...
	public static class Entry extends AlwaysSelectedEntryListWidget.Entry<AccountsListWidget.Entry> {
		...
		private static final Identifier checkmark = Identifier.of(AxolotlClientCommon.MODID, "textures/check.png");
		private static final Identifier warningSign = Identifier.of(AxolotlClientCommon.MODID, "textures/warning.png");
