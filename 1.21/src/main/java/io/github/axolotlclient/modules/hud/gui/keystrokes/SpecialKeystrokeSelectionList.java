...
public class SpecialKeystrokeSelectionList extends ElementListWidget<SpecialKeystrokeSelectionList.Entry> {
	...
	public class KeyEntry extends Entry {
		...
		KeyEntry(final KeystrokeHud.SpecialKeystroke key) {
			...
			this.addButton = ButtonWidget.builder(Text.translatable("keystrokes.stroke.add"), button -> keyBindsScreen.hud.keystrokes.add(keyBindsScreen.hud.newSpecialStroke(key)))
