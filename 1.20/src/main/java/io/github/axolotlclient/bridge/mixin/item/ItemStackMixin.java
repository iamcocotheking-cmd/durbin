...
public abstract class ItemStackMixin implements AxoItemStack {
	...
	public int br$getEnchantment(AxoEnchant enchant) {
		...
		Preconditions.checkArgument(enchant instanceof Enchantment, "enchant instanceof Enchantment");
		return EnchantmentHelper.getLevel((Enchantment) enchant, (ItemStack) (Object) this);
	}
	...
	public void br$setEnchantment(AxoEnchant enchant, int level) {
		...
		map.put((Enchantment) enchant, level);
