...
public interface ResourceManagerMixin extends ResourceFactory, AxoResourceManager {

	@Shadow
	Map<Identifier, Resource> findResources(String par1, Predicate<Identifier> par2);
	...
	default Map<AxoIdentifier, AxoResource> br$listResources(String namespace, String prefix, Predicate<AxoIdentifier> filter) {
		...
		return (Map<AxoIdentifier, AxoResource>) (Object) findResources(prefix, filter::test);
	}
