...
public class PlayerHud extends PlayerHudCommon {
	...
	private void renderEntityInInventory(
		...
		guiGraphicsExtractor.guiRenderState.submitPicturesInPictureState(new PlayerHudEntityRenderState(reusedPlayerRendererState, vector3f, quaternionf, quaternionf2, i, j, k, l, f, guiGraphicsExtractor.scissorStack.peek(), renderer));
	}
